...
while True:
    ...
    if choice == '1':
        ...
        vmid = get_input_less_than_N("Enter any sample VMID (less than public key): ", public_key_N)
        pin = get_input_less_than_N("Enter any sample PIN (less than public key): ", public_key_N)
